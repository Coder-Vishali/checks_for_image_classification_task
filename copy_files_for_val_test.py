...
source_image = os.path.join(os.getcwd(), r'dataset_frames')

dest_train_label = os.path.join(os.getcwd(), r'data\labels\val')
dest_train_image = os.path.join(os.getcwd(), r'data\images\val')

dest_test_label = os.path.join(os.getcwd(), r'data\labels\test')
dest_test_image = os.path.join(os.getcwd(), r'data\images\test')

trainlist = os.path.join(os.getcwd(), r'data_splits\vallist_1.txt')
